...
*/
   ...
   /*                 int curCol=i;
                    ...
                    while ((pWidth >= 1) && (canMoveUp)) {
                        // If above is not empty
                     //   System.out.println("g1.board[curRow-1][curCol]="+g1.board[curRow][curCol-1]);
                        if (g1.board[curRow][curCol-1]!=0){
                            canMoveUp=false;
                        }
                        curRow++;
                    ...
                    if (canMoveUp) {
                        System.out.println("canMoveUp=true");
                        Move myMove=new Move(piece, Move.Direction.UP);
                        listOfMoves.add(myMove);
                    }
                    else {
                        System.out.println("canMoveUp=false");
                    }
                    ...
                    while ((pWidth >= 1) && (canMoveDown)) {
                        // If above is not empty
                        System.out.println("g1.board[curRow][curCol+1]="+g1.board[curRow][curCol+1]);
                        if (g1.board[curRow][curCol+1]!=0){
                            canMoveDown=false;
                        }
                        curRow++;
                    ...
                    if (canMoveDown) {
                        System.out.println("canMoveDown=true");
                        Move myMove=new Move(piece, Move.Direction.DOWN);
                        listOfMoves.add(myMove);
                    }
                    else {
                        System.out.println("canMoveDown=false");
                    }
                    ...
                    if (canMoveLeft) {
                        ...
                        System.out.println("canMoveLeft=false");
                    }
*/
                    // Force the loops to end
                    i=g1.getHeight();
